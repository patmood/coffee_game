...
var Block, Dirt, Entity, Ladder, Level, Ninja, Player, Rock, Treasure, gfx, keys, levels, utils, _ref, _ref1,
  __slice = [].slice,
...
Ninja = (function(_super) {
  ...
  Ninja.prototype.update = function() {
    var px, py, xo, yo, _ref2;
    _ref2 = (function() {
      var _ref2;
      if (this.falling) {
        return [0, 0];
      } else {
        _ref2 = this.player, px = _ref2.x, py = _ref2.y;
        switch (this.state) {
          case "CRUISING":
