...
var Block, Dirt, Entity, Gravel, Ladder, Level, Ninja, Player, Rock, Treasure, gfx, keys, levels, utils, _ref, _ref1, _ref2,
  __slice = [].slice,
...
Entity = (function() {
  ...
  Entity.prototype.move = function(x, y) {
    var bl, br, tl, tr, xo, xv, yo, yv, _ref3, _ref4;
    if (this.falling) {
      y += this.speed * 2;
    }
  ...
  Entity.prototype.checkNewPos = function(origX, origY) {
    var bl, block, br, nearBlocks, snapAmount, tl, touchingALadder, tr, _i, _len, _ref3;
    this.wasOnLadder = this.onLadder;
    nearBlocks = (_ref3 = this.level.getBlocks([this.x, this.y], [this.x, this.y + this.h], [this.x + (this.w - 1), this.y], [this.x + (this.w - 1), this.y + this.h]), tl = _ref3[0], bl = _ref3[1], tr = _ref3[2], br = _ref3[3], _ref3);
...
Ninja = (function(_super) {
  ...
  Ninja.prototype.update = function() {
    var px, py, xo, yo, _ref3;
    _ref3 = (function() {
      var _ref3;
      if (this.falling) {
        return [0, 0];
      } else {
        _ref3 = this.player, px = _ref3.x, py = _ref3.y;
        switch (this.state) {
          case "CRUISING":
    ...
    }).call(this), xo = _ref3[0], yo = _ref3[1];
    return this.move(xo, yo);
  };
